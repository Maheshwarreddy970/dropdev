...
export const Smoothaccordion = () => {
    ...
    return (
        <div className="w-full flex justify-center">
            <div className="w-[600px] bg-white h-max border rounded-lg overflow-hidden">
                {frequentlyAskQuestions.map((item, i) => (
                    <div key={i} className="border-b last:border-b-0">
                        <div
                            className={`px-5 py-4 flex items-center justify-between ${activeId === i ? "bg-gray-100" : ""
                                }`}
                        ...
                        >
                                {activeId === i ? (
                                    ...
                                    <>
                                         <p className="flex-1 hover:text-indigo-600">{item.title}</p>
                                        <svg className='text-gray-900 transition duration-500 hover:text-indigo-600 accordion-active:text-indigo-600 accordion-active:rotate-180' width='22' height='22' viewBox='0 0 22 22' fill='none' xmlns='http://www.w3.org/2000/svg'>
                                            <path d='M16.5 8.25L12.4142 12.3358C11.7475 13.0025 11.4142 13.3358 11 13.3358C10.5858 13.3358 10.2525 13.0025 9.58579 12.3358L5.5 8.25' stroke='currentColor' stroke-width='1.6' stroke-linecap='round' stroke-linejoin='round'></path>
                                        </svg>
                                    </>
                                )}
